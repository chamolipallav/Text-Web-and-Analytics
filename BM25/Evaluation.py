...
def Eval(inputpath, i, count):
    ...
    for line in open("/Users/pallavchamoli/Downloads/IFN647/Assignment 2 IFN647/assignment deliverable/BM25/BM25_results/result_R" + str(count) + ".dat"):
        line = line.strip()
        lineList = line.split()
...
if count == 51:
    ...
    k = 0
    g = 0
    writeFile = open("/Users/pallavchamoli/Downloads/IFN647/Assignment 2 IFN647/assignment deliverable/BM25/BM25_effective_measure/Eval_Result.dat", 'w')
