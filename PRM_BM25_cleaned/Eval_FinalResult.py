...
def Eval(inputpath, i, count):
    ...
    for line in open("E:\Downloads\Downloads\Ayush\PRM_BM25_cleaned\RelevanceFeedback\Dataset" + str(i) + ".txt"):
        line = line.strip()
        lineList = line.split()
        A[lineList[1]] = int(float(lineList[2]))
    for line in open("E:\Downloads\Downloads\Ayush\PRM_BM25_cleaned\PRM_test_result\Test_ranks_PR" + str(i) + ".dat"):
        line = line.strip()
        lineList = line.split()
...
if __name__ == "__main__":
    ...
    if count == 51:
        ...
        k = 0
        g = 0
        writeFile = open("E:\Downloads\Downloads\Ayush\PRM_BM25_cleaned\PRM_Eval\PRM_Eval_Result.dat", 'w')
        # writeFile2 = open("E:\Downloads\Downloads\Ayush\PRM_BM25\PRM_Eval\PRM_Eval_Result_plot.dat", "w")
